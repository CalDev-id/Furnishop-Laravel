<div class="container">
    <div id="header" class="container bg-transparent hidden md:block text-white">
        <div class="container navbar bg-transparent absolute z-10 -translate-x-10 text-base-200">
            <div class="flex-1">
...
<div class="md:hidden w-full overflow-x-hidden bg-base-200">
    <div id="header2" class="navbar absolute z-50 w-full">
        <div class="navbar-start">
            <div class="dropdown">
                <label tabindex="0" class="btn btn-ghost btn-circle text-base-200">
                ...
                <ul tabindex="0" class="menu menu-compact dropdown-content shadow bg-base-100 min-h-[90vh] mx-0">
                    <li class="py-10 px-10"><a href="/">Home</a></li>
        ...
        <div class="navbar-center">
            <a href="/" class="btn btn-ghost normal-case text-xl text-base-200">Furnishop</a>
        </div>
        <div class="navbar-end">
            <button class="btn btn-ghost btn-circle text-base-200" onclick="location.href='/#menu';">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
